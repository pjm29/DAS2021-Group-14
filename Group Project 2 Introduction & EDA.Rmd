...
We will apply a Binomial Generalised Linear Model and we will initially consider the logit link. We assume this model since we have a binary response variable $Y_i$ and we have independent obvservations. There is some evidence of collinearity which we will ignore for now.
