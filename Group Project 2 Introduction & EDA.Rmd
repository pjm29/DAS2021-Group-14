...
Initially, We discuss the geographical distribution of coffee beans of different qualities. We had a look at top 5 countries in the number of good quality batches. 
...
#tidy data
data14_tidy<-data14[c(-536,-176),]
```
It shows that the coffee beans origin from Mexico, Colombia and Guatemala have the higher proportion of good quality in general. The number of batches in good quality are 192, 155, and 150 in these three countries respectively.
