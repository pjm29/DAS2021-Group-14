...
```
Figure \ref{fig:box} shows that aroma grade, flavor grade and acidity grade of coffee beans in good quality class tend to be higher than that in poor quality class. The distribution of outliers are also consistent with this conclusion. In terms of this result, these three variables can be considered as influence factors of coffee quality and will be analyzed later.
